...
export default async function Page() {
    ...
    return (
        <div className="flex flex-col gap-5  md:grid md:grid-cols-5 md:gap-x-24 md:gap-y-32 text-lg items-center">
            ...
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        <Link
                            href="/cabins"
                            className="inline-block mt-4 bg-accent-500 px-8 py-5 text-primary-800 text-sm sm:text-lg font-semibold hover:bg-accent-600 transition-all"
                        >
